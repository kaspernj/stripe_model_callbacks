...
describe "subscription_schedule created" do
  describe "#execute!" do
    ...
    it "saves data correct from stripe", :aggregate_failures do
      stripe_event
      ...
      expect(stripe_subscription_schedule.created).to eq Time.zone.parse("2020-05-11 15:46:01")
      ...
      expect(stripe_subscription_schedule.stripe_customer_id).to eq "cus_HG9VgDZsSjwhZG"
      ...
      expect(stripe_subscription_schedule.end_behavior).to eq "release"
      ...
      expect(stripe_subscription_schedule.renewal_behavior).to eq "release"
    ...
    it "saves subscription_schedule_phases data from stripe", :aggregate_failures do
      ...
      expect(stripe_subscription_schedule_phase.end_date).to eq Time.zone.parse("2021-06-12 00:00:00")
      ...
      expect(stripe_subscription_schedule_phase.start_date).to eq Time.zone.parse("2021-05-12 00:00:00")
