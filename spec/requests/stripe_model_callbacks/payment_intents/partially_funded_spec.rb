...
describe "payment intents - partially funded" do
  ...
  describe "#execute!" do
    it "updates the payment intent and logs it" do
      expect { mock_stripe_event("payment_intent.partially_funded") }
        ...
        .and change(ActiveRecordAuditable::Audit.where_type("StripePaymentIntent").where_action("partially_funded"), :count).by(1)
